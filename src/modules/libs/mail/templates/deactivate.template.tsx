      ...
      <Tailwind>
        <Body className="max-w-2xl mx-auto p-6 bg-slate-50">
            <Section className="text-center mb-8">
                <Heading className="text-3xl text-black font-bold">Request to Deactivate Account</Heading>
                <Text className="text-base text-black">We received a request to deactivate your account. If you did not make this request, please ignore this email.</Text>
            </Section>
            <Section className='bg-gray-100 rounded-lg p-6 mb-6 text-center'>
                <Heading className='text-2xl text-black font-semiblod'>Deactivation Code:</Heading>
                <Heading className='text-3xl text-black font-semiblod'>{token}</Heading>
                <Text className='text-black-600'>This code will expire in 5 minutes.</Text>
            </Section>
